...
public class CustomLaser : MonoBehaviour
{
    ...
    //Event
    public delegate void onCollisionWithObject();
    public static event onCollisionWithObject OnCollisionWithObject;

    public delegate void onCollisionWthHurdle();
    public static event onCollisionWthHurdle OnCollisionWthHurdle;
    void Start()
    {
    ...
    void Update()
    {
        ...
        if (Laser != null && UpdateSaver == false)
        {
            ...
            {
                if (hit.collider.CompareTag("LightHouse"))
                {
